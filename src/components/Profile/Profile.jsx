...
const Profile = () => {
  ...
  const getPercents = () => {
    return Math.round(
      (100 / studentProgress.lessons.length) * studentProgress.progres_classwork
    );
  };
      ...
      <div className={styles.userInfo}>
        ...
        <div className={styles.userInfoCard}>
          ...
          <div className={styles.courseInfo}>
            ...
            <p>
              Level: <span>{capitalize(studentProgress.level)}</span>
            </p>
            {!isTeacher() && (
              <div className={styles.studentProgress}>
                <span>Progress</span>
                <div className={styles.progress}>
                  <span className={styles.percent}>{getPercents()}%</span>
                  <div
