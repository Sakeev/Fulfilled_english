    ...
    <>
      <Box sx={taskBox}>
        ...
        <Box sx={{display: 'flex', padding: "20px 0", alignItems: 'center'}}>
          <TextField sx={inputBox} onChange={(e)=>setInps({...inps , first:e.target.value})}  ></TextField>
          <Typography>you</Typography>
          <TextField sx={{...inputBox, ml: 3}} onChange={(e)=>setInps({...inps , second:e.target.value})} ></TextField>
