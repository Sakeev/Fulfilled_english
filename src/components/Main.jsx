    ...
    return (
        <Box sx={{mt: 1, display: 'flex', flexDirection: 'column', width: '75vw', padding: '0 2%' }}>
            <Box sx={{display: 'flex', width: '100%', justifyContent: 'space-between'}}>
                <Box sx={{width: '65%'}}>
                    <Paper elevation={3} sx={{m: 2,height: '28vh', maxHeight: "220px", width: "100%", p: 2, bgcolor:'#EDF6F9', 
                        borderRadius: "50px 10px 10px", display: 'flex', justifyContent: 'space-around', alignItems: 'center'}} onClick={()=>alert('вы начали занятие')}>
